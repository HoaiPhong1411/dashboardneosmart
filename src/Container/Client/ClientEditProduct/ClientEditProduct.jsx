...
const ClientEditProduct = () => {
    ...
    return (
        <>
            <div className="flex flex-row gap-5 w-full items-center dark:bg-[black] bg-[white] py-5 px-10 rounded-xl">
                <h1 className="dark:text-[#fff] text-[black] text-[1.4rem]">
                    Edit Product
                </h1>
                <div className="w-[40%] relative">
                    ...
                    <input
                        ...
                        type="text"
                        value={value}
                        className="w-full outline-none py-[0.4rem] text-sm rounded-md px-4 dark:bg-[black] bg-[white] dark:text-[#ffffff] text-[black] border-[1px] dark:border-[white] border-[black]"
                    ...
                    <ul
                        ...
                        className=" w-full h-[19rem] dark:bg-[black] bg-[white]  absolute top-[100%] left-0 overflow-hidden overflow-y-scroll"
                    >
                        {dataNew?.map((item) => (
                            <li
                                onClick={() => handleGetProduct(item.id)}
                                className="dark:text-[#fff] text-[black] text-[0.9rem] px-3 py-2 cursor-pointer"
                            >
                                {item.title}
                            </li>
                        ))}
            ...
            <div className="flex flex-row gap-5 w-full dark:bg-[black] bg-[white] py-5 px-10 rounded-xl mt-7">
                <form
                    className="w-full"
                    action=""
                ...
                >
                    {product?.map((item) => (
                        <table className="w-full dark:text[white] text-[black] flex flex-col gap-5">
                            <div className="w-full flex flex-col gap-5 justify-between items-center dark:text-[#fff] text-[white]">
                                <div
                  ...
                  gap-5"
                                >
                                    <img
                                        ...
                                        alt=""
                                        className="w-[60%] bg-cover border-2 dark:border-[white] border-[black]"
                                    />
                                    <input
                                        type="file"
                                        name="photo"

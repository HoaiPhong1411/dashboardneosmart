...
export const clientApi = {
    ...
    productEdit(id, data) {
        return callApi(`http://localhost:8000/api/product/update/${id}`, "POST", data)
    },
    productAdd(data) {
        return callApi("http://localhost:8000/api/product/store", "POST", data)
    },
    productDelete(id) {
        return callApi(`http://localhost:8000/api/product/delete/${id}`, "DELETE")
    },
    ...
    categoryEdit(id, data) {
        return callApi(`http://localhost:8000/api/category/update/${id}`,"POST", data)
    },
    categoryAdd(data) {
        return callApi('http://localhost:8000/api/category/store', "POST", data)
    },
    categoryDelete(id) {
        return callApi(`http://localhost:8000/api/category/delete/${id}`, "DELETE")
    },
    ...
    blogEdit(id, data) {
        return callApi(`http://localhost:8000/api/blog/update/${id}`, "POST", data)
    },
    blogDisplay(id, display) {
        return callApi(`http://localhost:8000/api/blog/updateDisplay/${id}`, "POST", display)
    },
    blogAdd(data) {
    ...
    listBlogEdit(id, data) {
        return callApi(`http://localhost:8000/api/listblog/update/${id}`, "POST", data)
    },
    listBlogDelete(id) {
        return callApi(`http://localhost:8000/api/listblog/delete/${id}`, "DELETE")
    },
    ...
    menuEdit(id, data) {
        return callApi(`http://localhost:8000/api/menu/update/${id}`, "POST", data)
    },
    menuShowAdd(data) {
    ...
    messageUpdateStatus(id, status) {
        return callApi(`http://localhost:8000/api/client-message/update/${id}`, "POST" ,status)
    },
